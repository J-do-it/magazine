           ...
           {article.intro && (
            ...
            <div
              className="prose prose-lg max-w-none prose-gray
                ...
                prose-h2:text-gray-900 prose-h2:font-bold prose-h2:p-3 prose-h2:border-l-4 prose-h2:border-jj prose-h2:tracking-tighter
                prose-h3:text-gray-700 prose-h3:font-bold prose-h3:tracking-tighter prose-h3:text-xl
